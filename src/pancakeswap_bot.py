    ...
    def work(self):
        while self.__abort != True:
            ...
            all_token_information = [
                ...
                (
                    3,
                    str(configfile.token3ethaddress),
                    float(configfile.token3high),
                    float(configfile.token3low),
                    float(configfile.activatetoken3),
                    float(configfile.token3stoploss),
                    float(configfile.stoplosstoken3),
                    float(configfile.tradewithERCtoken3),
                    float(configfile.tradewithETHtoken3),
                    "0",
                    str(configfile.token3name),
                    int(configfile.token3decimals),
                ),
                (
                    4,
                    str(configfile.token4ethaddress),
                    float(configfile.token4high),
                    float(configfile.token4low),
                    float(configfile.activatetoken4),
                    float(configfile.token4stoploss),
                    float(configfile.stoplosstoken4),
                    float(configfile.tradewithERCtoken4),
                    float(configfile.tradewithETHtoken4),
                    "0",
                    str(configfile.token4name),
                    int(configfile.token4decimals),
                ),
                (
                    5,
                    str(configfile.token5ethaddress),
                    float(configfile.token5high),
                    float(configfile.token5low),
                    float(configfile.activatetoken5),
                    float(configfile.token5stoploss),
                    float(configfile.stoplosstoken5),
                    float(configfile.tradewithERCtoken5),
                    float(configfile.tradewithETHtoken5),
                    "0",
                    str(configfile.token5name),
                    int(configfile.token5decimals),
                ),
                (
                    6,
                    str(configfile.token6ethaddress),
                    float(configfile.token6high),
                    float(configfile.token6low),
                    float(configfile.activatetoken6),
                    float(configfile.token6stoploss),
                    float(configfile.stoplosstoken6),
                    float(configfile.tradewithERCtoken6),
                    float(configfile.tradewithETHtoken6),
                    "0",
                    str(configfile.token6name),
                    int(configfile.token6decimals),
                ),
                (
                    7,
                    str(configfile.token7ethaddress),
                    float(configfile.token7high),
                    float(configfile.token7low),
                    float(configfile.activatetoken7),
                    float(configfile.token7stoploss),
                    float(configfile.stoplosstoken7),
                    float(configfile.tradewithERCtoken7),
                    float(configfile.tradewithETHtoken7),
                    "0",
                    str(configfile.token7name),
                    int(configfile.token7decimals),
                ),
                (
                    8,
                    str(configfile.token8ethaddress),
                    float(configfile.token8high),
                    float(configfile.token8low),
                    float(configfile.activatetoken8),
                    float(configfile.token8stoploss),
                    float(configfile.stoplosstoken8),
                    float(configfile.tradewithERCtoken8),
                    float(configfile.tradewithETHtoken8),
                    "0",
                    str(configfile.token8name),
                    int(configfile.token8decimals),
                ),
                (
                    9,
                    str(configfile.token9ethaddress),
                    float(configfile.token9high),
                    float(configfile.token9low),
                    float(configfile.activatetoken9),
                    float(configfile.token9stoploss),
                    float(configfile.stoplosstoken9),
                    float(configfile.tradewithERCtoken9),
                    float(configfile.tradewithETHtoken9),
                    "0",
                    str(configfile.token9name),
                    int(configfile.token9decimals),
                ),
                (
                    10,
                    str(configfile.token10ethaddress),
                    float(configfile.token10high),
                    float(configfile.token10low),
                    float(configfile.activatetoken10),
                    float(configfile.token10stoploss),
                    float(configfile.stoplosstoken10),
                    float(configfile.tradewithERCtoken10),
                    float(configfile.tradewithETHtoken10),
                    "0",
                    str(configfile.token10name),
                    int(configfile.token10decimals),
                ),
            ]
            ...
            def gettotaltokenbalance(
                ...
                try:  # balances
                    if ethaddress == "0x0000000000000000000000000000000000000000":
                        ...
                        balance_eth = ethbalance.get_token_balance(
                            "potter", ethereum_address
                        )["balance"]
                        maintokeneth = uniswap_wrapper.get_eth_token_input_price(
                            w33.toChecksumAddress(ethaddress), 100
                        )
                    ...
                    if len(all_token_information[0]) > 14:
                        for (
                            ...
                            if eth_address != "0" or "":
                                erc20tokens = ethbalance.add_token(
                                    small_case_name,
                                    {
                                        "symbol": small_case_name,
                                        "address": eth_address,
                                        "decimals": decimals,
                                        "name": small_case_name,
                                    },
                                )
                                a = ethbalance.get_token_balance(
                                    small_case_name, ethereum_address
                                )["balance"]
                                all_token_information[
                                    token_number - 1
                                ] = all_token_information[token_number - 1][:12] + (
                                    a,
                                    all_token_information[token_number - 1][13],
                                    all_token_information[token_number - 1][14],
                                )
                            else:
                                a = 0
                                all_token_information[
                        ...
                        for (
                            ...
                            if eth_address != "0" or "":
                                ...
                                erc20tokens = ethbalance.add_token(
                                    small_case_name.upper, details
                                )
                                a = ethbalance.get_token_balance(
                                    small_case_name.upper, ethereum_address
                                )["balance"]
                                all_token_information[
                                    token_number - 1
                                ] = all_token_information[token_number - 1] + (a,)
                            else:
                                a = 0
                                all_token_information[
                                    token_number - 1
                    ...
                    if len(all_token_information[0]) > 14:
                        for (
                            ...
                            if str(eth_address) != "0" or "":
                                token1eth = uniswap_wrapper.get_eth_token_input_price(
                                    w33.toChecksumAddress(eth_address), 10000000000000
                                )
                                if decimals != 18:
                        ...
                        for (
                            ...
                            if str(eth_address) != "0" or "":
                                try:
                                    token1eth = (
                                        uniswap_wrapper.get_eth_token_input_price(
                                    ...
                                    if "Could not decode" in str(e):
                                        try:
                                            ...
                                            kanka2 = (
                                                uniconnect._load_contract(
                                                    abi_name="erc20",
                                                    address=w33.toChecksumAddress(
                                                        eth_address
                                                    ),
                                                )
                                                .functions.balanceOf(kanka)
                                                .call
                                            )
                                            if kanka2 < 2:
                                                print(
                                                    "Token "
                                                    + str(token_number)
                                                    + " has no liquidity on Pancakeswap 2"
                                                )
                                        except:
                                            print(
                                                "Token "
                ...
                if len(all_token_information[0]) > 14:
                    for (
                        ...
                        if balance != 0:
                            ...
                            all_token_information[
                                token_number - 1
                            ] = all_token_information[token_number - 1][:14] + (a,)
                        else:
                            a = 0
                            all_token_information[
                                token_number - 1
            ...
            def checkbalance(
                ...
                for (
                    ...
                    if dollarbalancemaintoken > mcotoseeassell and gelukt != "sell":
                        ...
                        if (
                            dollar_balance > mcotoseeassell
                            and gelukt != "buy " + small_case_name
                        ):
            ...
            def getprice(
                ...
                try:
                    ...
                    if ethaddress != "0x0000000000000000000000000000000000000000":
                        if ethaddress == "0x1af3f329e8be154074d8769d1ffa4ee058b1dbc3":
                            jajaja = float(
                                (
                                    requests.get(
                                        "https://api.binance.com/api/v3/ticker/price?symbol=BUSDDAI"
                                    ).json()
                                )["price"]
                            )
                            priceeth = int(
                        ...
                        if ethaddress == "0x8ac76a51cc950d9822d68b83fe1ad97b32cd580d":
                            jajaja = float(
                                (
                                    requests.get(
                                        "https://api.binance.com/api/v3/ticker/price?symbol=USDCBUSD"
                                    ).json()
                                )["price"]
                            )
                            priceeth = int(
                    ...
                    if ethaddress == "0x0000000000000000000000000000000000000000":
                        ...
                        token11eth = uniswap_wrapper.get_token_eth_output_price(
                            w33.toChecksumAddress(ethaddress), threeeth
                        )
                        token11eth2 = token11eth / threeeth

                        if maindecimals != 18:
                            dollarbalancemaintoken = float(maintokenbalance) * (
                                (priceeth / (token11eth2))
                                / (10 ** (18 - (maindecimals)))
                            )
                        else:
                            dollarbalancemaintoken = maintokenbalance * (
                                priceeth / (token11eth2)
                            )
                    priceeth = int(
                        float(
                    ...
                    for (
                        ...
                        if eth_address != "0":
                            if priceright == "sell":
                                token1eth = uniswap_wrapper.get_eth_token_input_price(
                                    w33.toChecksumAddress(eth_address), threeeth
                                )
            ...
            def letstrade(
                        ...
                        if eth_address != eth_address2:
                            if eth_address != 0 and eth_address2 != 0:
                                if price > ((high + low) / 2) and price2 < (
                                    ...
                                    locals()[
                                        "token%stotoken%s"
                                        % (str(token_number), str(token_number2))
                                    ] = ((price - low) / (high - low)) / (
                ...
                def makeTrade(
                    ...
                    try:
                        ...
                        # Written by Aviddot: https://github.com/aviddot/Pancakeswap-v2-trading-bot
                        print(
                            "Current gwei chosen for trading:"
                            + configfile.maxgweinumber
                            + ".   Current BNB price:$"
                            + str(
                                int(
                                    float(
                    ...
                    if 1 == 1:
                        ...
                        try:
                            uniconnect = Uniswap(
                                my_address,
                                pk,
                                web3=Web3(w33.HTTPProvider(infura_url)),
                                version=2,
                ...
                try:
                    for (
                        ...
                        price,
                        dollar_balance,
                    ) in all_token_information:  # stop loss
                        if (
                            price < stoploss_value
                            and stoploss_activate == 1
                            and activate == 1
                            and trade_with_ETH == 1
                            and gelukt == "buy " + small_case_name
                        ) or (
                            price < stoploss_value
                            and activate == 1
                            and trade_with_ETH == 1
                            and gelukt2 == "buy " + small_case_name
                            and stoploss_activate == 1
                        ):
                            print(
                                "Selling "
                                + str(small_case_name)
                                + " for Maincoin-option (current price in USD: "
                                + str(price)
                                + ")"
                            )
                            buysmallcasesymbol = "eth"
                            kaka = makeTrade(
                                buytokenaddress=ethaddress,
                                ...
                                sellsmallcasesymbol=small_case_name,
                                ethtokeep=ethtokeep,
                                speed=speed,
                                maxgwei=maxgwei,
                                maxgweinumber=maxgweinumber,
                            ...
                            all_token_information[
                                token_number - 1
                            ] = all_token_information[token_number - 1][:9] + (
                                fasttoken1,
                                all_token_information[token_number - 1][10],
                                all_token_information[token_number - 1][11],
                                all_token_information[token_number - 1][12],
                                all_token_information[token_number - 1][13],
                                all_token_information[token_number - 1][14],
                            )
                        if (
                            (eth_address != 0) and activate == 1 and trade_with_ETH == 1
                        ):  # sell alt and buy ETH trades
                            if (
                                (price > high and gelukt == "buy " + small_case_name)
                                or (
                                    price > high and gelukt2 == "buy " + small_case_name
                                )
                                or (
                                    activate == 1
                                    and gelukt == "buy " + small_case_name
                        ...
                        if (
                            ...
                            if (price < low and gelukt == "sell") or (
                                ...
                                kaka = makeTrade(
                                    ...
                                    sellsmallcasesymbol=sellsmallcasesymbol,
                                    ethtokeep=ethtokeep,
                                    speed=speed,
                                    maxgwei=maxgwei,
                                    maxgweinumber=maxgweinumber,
                            ...
                            for (
                                ...
                                if eth_address2 != eth_address:
                                    if (
                                        ...
                                        and trade_with_ETH == 1
                                        and activate2 == 1
                                        and trade_with_ETH2 == 1
                                        and trade_with_ERC == 1
                                        and trade_with_ERC2 == 1
                                    ):
                                        if (
                                            locals()[
                                                "token%stotoken%s"
            ...
            if 0 == 1:
                details2 = {
                    "symbol": paytokensmallname,
                    "address": paytokenaddress,
                    "decimals": paytokendecimals,
                    "name": paytokenname,
                }
                erc20tokens2 = ethbalance.add_token(token2, details2)
                ethamount2 = ethbalance.get_token_balance(paytokenname, my_address)[
                    "balance"
                ]
                QCoreApplication.processEvents()
                if ethamount2 < paytokenamount:
                    print(
                        "You are not holding the required token, the application will now stop"
                    )
                    exit()
            ...
            while self.__abort != True:
                ...
                try:
                    ...
                    ethereum_address = address
                    if (
                        "gelukt" not in locals()
                        or gelukt == "mislukt"
                        or gelukt == "mislukt buy"
                        or gelukt == "mislukt sell"
                    ):
                        if "step" not in locals():
                            step = 1
                        else:
                        ...
                        print(
                            "Last thing we did is "
                            + gelukt
                            + ". Second token available for trading is "
                            + gelukt2
                        )
                    if "step" not in locals():
                        step = 1
                    ...
                    while self.__abort != True:
                        ...
                        try:
                            ...
                            totaldollars = (
                                dollarbalancemaintoken
                                + all_token_information[0][14]
                                + all_token_information[1][14]
                                + all_token_information[2][14]
                                + all_token_information[3][14]
                                + all_token_information[4][14]
                                + all_token_information[5][14]
                                + all_token_information[6][14]
                                + all_token_information[7][14]
                                + all_token_information[8][14]
                                + all_token_information[9][14]
                            )

                            QCoreApplication.processEvents()
                            weergavegeld = (
                                str(configfile.maincoinoption)
                                + ":$"
                                + str("{:.2f}".format(dollarbalancemaintoken))
                            )
                            for (
                                token_number,
                                eth_address,
                            ...
                            if "pricetoken1usd2" in locals() and 0 == 1:
                                for (
                                    ...
                                    if (
                                        price
                                        / locals()[
                                            "pricetoken%susd2" % (str(token_number))
                                        ]
                                        >= 1.15
                                        and price > low
                                        and gelukt == "buy " + small_case_name
                                        ...
                                        all_token_information[
                                            token_number - 1
                                        ] = all_token_information[token_number - 1][
                                            :9
                                        ] + (
                                            1,
                                            all_token_information[token_number - 1][10],
                                        ...
                                        all_token_information[
                                            ...
                                            price / 1.09,
                                            all_token_information[token_number - 1][4],
                                            all_token_information[token_number - 1][5],
                                            all_token_information[token_number - 1][6],
                                            all_token_information[token_number - 1][7],
                                            all_token_information[token_number - 1][8],
                                            all_token_information[token_number - 1][9],
                                            all_token_information[token_number - 1][10],
                                            all_token_information[token_number - 1][11],
                                            all_token_information[token_number - 1][12],
...
class Ui_MainWindow(QGraphicsObject):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(
            _translate("MainWindow", "Pancakeswap trading bot no.2")
        )
        ...
        self.sleepbox.setText(
            _translate("MainWindow", "Seconds between checking price (min. 1 sec)")
        )
        self.tokentokennumeratorbox.setText(
            _translate("MainWindow", "Tokentokennumerator (3.3= standard)")
        )
    ...
    def updatenames(self):
        try:
            if self.token1ethaddress.text() != "" or "0":
                ...
                token1smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token1ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token2ethaddress.text() != "" or "0":
                ...
                token2smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token2ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token3ethaddress.text() != "" or "0":
                ...
                token3smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token3ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token4ethaddress.text() != "" or "0":
                ...
                token4smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token4ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token5ethaddress.text() != "" or "0":
                ...
                token5smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token5ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token6ethaddress.text() != "" or "0":
                ...
                token6smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token6ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token7ethaddress.text() != "" or "0":
                ...
                token7smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token7ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token8ethaddress.text() != "" or "0":
                ...
                token8smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token8ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token9ethaddress.text() != "" or "0":
                ...
                token9smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token9ethaddress.text(), id="binancecoin"
                )["symbol"]
        ...
        try:
            if self.token10ethaddress.text() != "" or "0":
                ...
                token10smallcasename = cg.get_coin_info_from_contract_address_by_id(
                    contract_address=self.token10ethaddress.text(), id="binancecoin"
                )["symbol"]
